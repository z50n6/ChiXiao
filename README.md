...
![image-20260208144512705](./imgs/image-20260208144512705.png)
...
![image-20260208144529281](./imgs/image-20260208144529281.png)



![image-20260208144542293](./imgs/image-20260208144542293.png)
...
![image-20260208144557211](./imgs/image-20260208144557211.png)



*   **社工字典生成**：基于个人信息（姓名、生日、手机号等）生成定制化的社工密码字典。

![image-20260208144608520](./imgs/image-20260208144608520.png)

![image-20260208144617516](./imgs/image-20260208144617516.png)

*   **弱口令查询**：内置常见弱口令库，支持快速查询与匹配。

![image-20260208144632685](./imgs/image-20260208144632685.png)

*   **Java 编码辅助**：提供 Java 相关的常见编码转换与利用辅助。



![image-20260208144641456](./imgs/image-20260208144641456.png)
...
![image-20260208144815507](./imgs/image-20260208144815507.png)



*   **IP 提取**：从凌乱的文本中快速提取 IPv4/IPv6 地址。

![image-20260208144830391](./imgs/image-20260208144830391.png)

*   **仓库更新**：一键更新本地工具仓库，保持工具库的最新状态。

![image-20260208144803675](./imgs/image-20260208144803675.png)
...
![image-20260208144750607](./imgs/image-20260208144750607.png)
...
![image-20260208144730923](./imgs/image-20260208144730923.png)
